                                ...
                                <div key={product.id} className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                                    ...
                                    <div className="pt-6 flex flex-col h-40">
                                        <div className="mb-4 flex items-center justify-between gap-4">
                                            <Link href={`/pharmacy/ProductDetail?id=${product.id}`} className="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">
                                                {product.name}
                                            </Link>
                                        </div>
                                        <div className="mt-2">
                                        ...
                                        <div className="mt-auto flex items-center justify-between w-full">
                                            ...
                                            <Link href={`/pharmacy/ProductDetail?id=${product.id}`}>
